...
import com.weather.vibe.data.remote.dto.ForecastResponseDto
...
fun WeatherData.toCacheEntity(): WeatherCacheEntity = WeatherCacheEntity(
...
fun WeatherCacheEntity.toWeatherData(): WeatherData = WeatherData(
    cityName = cityName,
