...
internal fun SplashEntry(backStack: NavBackStack<NavKey>) {
  SplashScreen(
    ...
    onNavigateToLocationOnboarding = { backStack.replaceWith(LocationOnboardingRoute) },
    onNavigateToWelcomeOnboarding = { backStack.replaceWith(WelcomeOnboardingRoute) }
  )
}
