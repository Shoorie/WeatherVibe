package com.weather.vibe.feature.settings.notifications.ui.component.weatheralerts
...
import com.weather.vibe.feature.settings.notifications.ui.NotificationsResources.Texts.weatherAlertsSection
import com.weather.vibe.feature.settings.notifications.ui.NotificationsResources.Texts.weatherAlertsSectionSubtitle
...
@Composable
internal fun WeatherAlertsSection(
  ...
  SettingsSection(
    modifier = modifier,
    emoji = Emojis.weatherAlerts(),
    title = weatherAlertsSection(),
    subtitle = weatherAlertsSectionSubtitle(),
